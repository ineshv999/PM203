...
const Laptops = [
  { id: '1', nombre: 'Laptop 1' },
  { id: '2', nombre: 'Laptop 2' },
  { id: '3', nombre: 'Laptop 3' },
  { id: '4', nombre: 'Laptop 4' },
  { id: '5', nombre: 'Laptop 5' },
  { id: '6', nombre: 'Laptop 6' },
];

const MENU = [
  { titulo: 'Laptops', data: ['Lenovo', 'Asus', 'Alienware'] },
  { titulo: 'Celulares', data: ['iPhone', 'Samsung', 'Google Pixel'] },
  { titulo: 'Consolas', data: ['PlayStation', 'Xbox', 'Nintendo Switch'] },
];
